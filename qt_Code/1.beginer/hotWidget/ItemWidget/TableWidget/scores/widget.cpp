...
void Widget::on_pushButtonFind_clicked()
{
    ...
    if (strDstScore.isEmpty()) return; //没有比较分值不查询
...
void Widget::on_pushButtonDelSelectedItems_clicked()
{
    ...
    for (int i = 0; i < nCount; ++i)
    {
        ...
        delete ui->tableWidget->takeItem(nItemRow, nItemColumn); //彻底删除
    }
    //清空列表
    listItems.clear();
}
...
void Widget::InitScoresTable()
{
    ...
    ui->tableWidget->setHorizontalHeaderLabels(listHeaders);//设置表头文本
